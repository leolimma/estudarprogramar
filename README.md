...
3. **Avanço Automático & Sistema de Vidas**:
   - Ao acertar, a fase avança automaticamente em **3 segundos**, permitindo a leitura da explicação pedagógica.
   - **Sistema Anti-Trapaça**: Trocas de janela ou aba durante a partida resultam na dedução de **1 vida** (de 3 vidas disponíveis), com alerta visual.
